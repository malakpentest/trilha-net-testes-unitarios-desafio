...
Para este desafio, Eu precisei usar seus conhecimentos adquiridos no módulo de Testes Unitários com C#, da trilha .NET da DIO.

## 🎖️ Contexto
Eu estou trabalhando em um sistema, e meus gestores relataram que frequentemente há problemas no software: bugs, funcionalidades que estavam funcionando de repente não funcionam mais, problemas de validações, entre outros. Os clientes já começam a duvidar da qualidade do código.
...
Os gestores aceitaram a minha ideia, e com isso, Eu precisei implementar testes unitários no sistema.
...
## 💡 Solução
O código de testes está completo , e eu dei continuidade implementando os testes descritos acima, para que no final, tenho um programa de testes funcional. Procurei pela palavra comentada "TODO" no código, em seguida, implementei conforme as regras acima.
